...
if(isset($_POST['submit'])){
    ...
    if($row > 0 ){
        ...
        header("location:../Admin/headings.php");
    }
    else{
        echo "<script>
        swal('Failed!', 'Invalid Crediental!', 'failed to login');
        </script>";
    }
...
<body>
    ...
    <div class="container">
        ...
        <div class="info-content Login">
            <h4 class="animation" style="--D:0; --S:20;">ADMIN LOGIN</h4>
            <p class="animation" style="--D:1; --S:21;">Welcome Back, Admin! Time to Ensure Seamless Deliveries.</p>
        </div>
...
//         setTimeout(function(){
//             window.location.href = '../Admin/headings.php'
//         }, 2000)
//         </script>";
//     }
