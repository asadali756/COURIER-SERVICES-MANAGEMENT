            ...
            <div class="card-body">
                ...
                <form method="POST">
                    ...
                    <div class="form-group row mt-3">
                        ...
                        <div class="col-sm-9">
                            <input type="text" value="<?php echo htmlspecialchars($row['password']); ?>" name="password" class="form-control" placeholder="Delivery Date" required>
                        </div>
                    </div>
                    <div class="form-group row mt-3">
...
if (isset($_POST['submit'])) {
    ...
    if ($stmt = $conn->prepare("UPDATE admin SET name = ?, email = ?, password = ? WHERE id = ?")) {
